...
/**
 * ## AWS Shared ALB with Domain
 *
 * Creates a standalone ALB with a custom domain, shared across multiple services.
 * Shows advanced routing with path conditions, header conditions, and health checks.
 *
 * The ALB is configured with a domain and SSL certificate:
 *
