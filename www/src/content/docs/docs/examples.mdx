...
View the [full example](https://github.com/sst/sst/tree/dev/examples/aws-bun).


---
## Custom bundle

Use the `bundle` option to point to a custom directory for your function code.
```ts title="sst.config.ts"
...
View the [full example](https://github.com/sst/sst/tree/dev/examples/aws-bundle).
...
Use the `copyFiles` option to include additional files alongside your function code.
```ts title="sst.config.ts"
...
View the [full example](https://github.com/sst/sst/tree/dev/examples/aws-copy-files).
...
View the [full example](https://github.com/sst/sst/tree/dev/examples/aws-deno).
...
View the [full example](https://github.com/sst/sst/tree/dev/examples/aws-monorepo).
...
View the [full example](https://github.com/sst/sst/tree/dev/examples/aws-rds-instance-mysql-public-example).
