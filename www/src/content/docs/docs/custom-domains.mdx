...
2. Set the Cloudflare token and account ID in your environment.
   ...
   Follow the [Cloudflare API token guide](/docs/cloudflare-api-token/) to create it.

   For custom domains, the token also needs **Zone - DNS - Edit** for the zones SST should update.
