...
export interface MapArgs extends StateArgs {
   ...
   * ```
   */
  mode?: sst.Input<"inline" | "standard" | "express">;
  /**
   ...
   */
  itemSelector?: sst.Input<Record<string, sst.Input<any>>>;
  /**
   ...
   * ```
   */
  maxConcurrency?: sst.Input<JSONata | number>;
  /**
