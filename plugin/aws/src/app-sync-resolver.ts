...
export interface ResolverArgs extends AppSyncResolverArgs {
   ...
   */
  type: sst.Input<string>;
  /**
   * The field name from the schema defined.
   */
  field: sst.Input<string>;
}
 ...
 */
export class AppSyncResolver extends sst.Component {
  private readonly resolver: appsync.Resolver;

  constructor(name: string, args: ResolverArgs, opts?: sst.ComponentOptions) {
    ...
    function normalizeKind() {
      return sst.output(args.kind ?? "unit").apply((kind) => {
