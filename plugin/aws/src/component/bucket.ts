...
interface BucketCorsArgs {
  ...
  allowMethods?: sst.Input<
    sst.Input<"DELETE" | "GET" | "HEAD" | "POST" | "PUT">[]
  >;
  /**
...
export interface BucketArgs {
   ...
   * ```
   */
  access?: sst.Input<"public" | "cloudfront">;
  /**
  ...
  policy?: sst.Input<
    sst.Input<{
       ...
       * ```
       */
      actions: sst.Input<sst.Input<string>[]>;
      /**
       ...
       *
       */
      principals: sst.Input<
        | "*"
        | sst.Input<{
            type: sst.Input<"aws" | "service" | "federated" | "canonical">;
            identifiers: sst.Input<sst.Input<string>[]>;
          }>[]
      >;
      /**
   ...
   * ```
   */
  enforceHttps?: sst.Input<boolean>;
  /**
   ...
   * @default `true`
   */
  cors?: sst.Input<false | BucketCorsArgs>;
  /**
...
export interface BucketNotificationsArgs {
  ...
  notifications: sst.Input<
    sst.Input<{
       ...
       * ```
       */
      topic?: sst.Input<string | SnsTopic>;
      /**
