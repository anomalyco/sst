...
import { Duration, DurationHours, toSeconds } from "../duration.js";
...
export interface ApiGatewayV2Args {
   ...
   * ```
   */
  domain?: sst.Input<string | Prettify<ApiGatewayV2DomainArgs>>;
  /**
   ...
   * ```
   */
  cors?: sst.Input<boolean | Prettify<ApiGatewayV2CorsArgs>>;
  /**
...
export interface ApiGatewayV2AuthorizerArgs {
  ...
  jwt?: sst.Input<{
     ...
     * ```
     */
    issuer: sst.Input<string>;
    /**
     * List of the intended recipients of the JWT. A valid JWT must provide an `aud` that matches at least one entry in this list.
     */
    audiences: sst.Input<sst.Input<string>[]>;
    /**
  ...
  lambda?: sst.Input<{
     ...
     * ```
     */
    function: sst.Input<string | FunctionArgs | FunctionArn>;
    /**
     ...
     * ```
     */
    identitySources?: sst.Input<sst.Input<string>[]>;
  }>;
  /**
   * [Transform](/docs/components#transform) how this component creates its underlying
   * resources.
 ...
 */
export class ApiGatewayV2 extends sst.Component implements sst.Linkable {
  private constructorName: string;
  private constructorArgs: ApiGatewayV2Args;
  private constructorOpts: sst.ComponentOptions;
  private api: apigatewayv2.Api;
  private apigDomain?: sst.Output<apigatewayv2.DomainName>;
  private apiMapping?: sst.Output<apigatewayv2.ApiMapping>;
  ...
  constructor(
    ...
    function createDomainName() {
      ...
      return sst.output(domain).apply((domain) => {
  ...
  public get url() {
    ...
    return this.apigDomain && this.apiMapping
      ? sst
          .resolve([this.apigDomain.domainName, this.apiMapping.apiMappingKey])
          .apply(([domain, key]) =>
  ...
  private buildRouteId(route: string) {
    const suffix = sst.naming.logical(
      sst.naming.hashStringToPrettyString([outputId, route].join(""), 6),
    );
