...
export interface AppSyncDataSourceArgs {
   ...
   * ```
   */
  lambda?: sst.Input<string | FunctionArgs | FunctionArn>;
  /**
   ...
   * ```
   */
  elasticSearch?: sst.Input<string>;
  /**
...
export interface AppSyncResolverArgs {
   ...
   * ```
   */
  functions?: sst.Input<sst.Input<string>[]>;
  /**
   ...
   * ```
   */
  requestTemplate?: sst.Input<string>;
  /**
   ...
   * ```
   */
  responseTemplate?: sst.Input<string>;
  /**
   * [Transform](/docs/components#transform) how this component creates its underlying
   * resources.
   */
...
export interface AppSyncFunctionArgs {
   ...
   * ```
   */
  requestMappingTemplate?: sst.Input<string>;
  /**
   ...
   * ```
   */
  responseMappingTemplate?: sst.Input<string>;
  /**
   * [Transform](/docs/components#transform) how this component creates its underlying
   * resources.
   */
 ...
 * ```
 */
export class AppSync extends sst.Component implements sst.Linkable {
  ...
  constructor(
    ...
    function normalizeDomain() {
      ...
      // validate
      sst.output(args.domain).apply((domain) => {
    ...
    function loadSchema() {
      return sst
        .output(args.schema)
        .apply(async (schema) => fs.readFile(schema, { encoding: "utf-8" }));
    }
  ...
  public get url() {
    return this.domainName
      ? sst.interpolate`https://${this.domainName.domainName}/graphql`
  ...
  public addResolver(operation: string, args: AppSyncResolverArgs) {
    ...
    const nameSuffix =
      `${sst.naming.logical(type)}` + `${sst.naming.logical(field)}`;
