 ...
 */
export class ApiGatewayV1IntegrationRoute extends sst.Component {
      ...
      return new apigateway.Integration(
        ...transform(
          ...
          `${name}Integration`,
          {
            ...
            ...args.integration,
            type: sst
              .output(args.integration.type)
              .apply((v) => v.toUpperCase().replaceAll("-", "_")),
            passthroughBehavior:
              args.integration.passthroughBehavior &&
              sst
                .output(args.integration.passthroughBehavior)
                .apply((v) => v.toUpperCase().replaceAll("-", "_")),
          },
          { parent: self },
        ),
